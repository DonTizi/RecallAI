  ...
  return (
    <>
      ...
      <h1 className="mt-14 font-display text-4xl/tight font-light text-white">
        Artificial Memory{' '}
        <span className="text-sky-300">for macOS users.</span>
      </h1>
      <p className="mt-4 text-sm/6 text-gray-300">
       RecallAI is an artificial memory where you can recall all your activity from your laptop. You can ask him whetever question about when did you
       searched something, or what did you do at this time. It will act like your personnal assistant with an artificial memory.
      </p>
      <SignUpForm />
      <div className="mt-8 flex flex-wrap justify-center gap-x-1 gap-y-3 sm:gap-x-2 lg:justify-start">
        <IconLink href="https://github.com/DonTizi" icon={GitHubIcon} className="flex-none">
          GitHub
        </IconLink>
      </div>
    </>
...
export function IntroFooter() {
  return (
    <p className="flex items-baseline gap-x-2 text-[0.8125rem]/6 text-gray-500">
      Brought to you by{' '}
      <IconLink href="https://twitter.com/E_melbou" icon={TwitterIcon} compact large>
